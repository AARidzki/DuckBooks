...
unset($__errorArgs, $__bag); ?>" id="kode_promo" name="kode_promo"
                required autofocus value="<?php echo e(old('kode_promo')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="promo" name="promo"
                required autofocus value="<?php echo e(old('promo')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="expire" name="expire"
                required autofocus value="<?php echo e(old('expire')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="count" name="count"
                required autofocus value="<?php echo e(old('count')); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-buku\resources\views/dashboard/discounts/create.blade.php ENDPATH**/ ?>